...
<button id="dropdownSmallButton" data-dropdown-toggle="dropdownSmall" class="inline-flex items-center px-3 py-2 mb-3 me-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg md:mb-0 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Menu<svg class="w-2 h-2 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
...
<form class="max-w-lg mx-auto py-10">
    ...
    <ul class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
        ...
        <div class="relative bg-white flex flex-col  border rounded shadow-md hover:shadow-primary-400">
            <div class="card-image">  
                <a class="relative" href="/tool/writey-ai">
                    <div class="relative w-full aspect-video">
                        <img class="rounded w-full h-full object-cover" src="https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw1fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Writey A.I" loading="lazy">
                        <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-700 to-gray-500 text-white">
                ...
                <div class=" flex flex-col justify-beetween gap-3 px-4 py-5">
                    <ul class="flex flex-wrap items-center justify-start gap-2">
                        <li title="Pricing type" class="flex items-center cursor-pointer gap-0.5 bg-sky-500 text-white px-8 py-1 rounded-full">
                            <span>Categories</span>
                        </li>
                    </ul>
                    <div class="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-600" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 20s6-8 6-12a6 6 0 0 0-12 0c0 4 6 12 6 12zM10 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" clip-rule="evenodd" />
                        </svg>
                        <h2 class="text-gray-600">Writey A.I</h2>
                    </div>
                    <div class="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class=" text-gray-600 icon icon-tabler icon-tabler-clock-hour-3" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                            <path d="M12 12h3.5" />
                            <path d="M12 7v5" />
                        </svg>
                        <h2 class="text-gray-600">Time</h2>
                    </div>
                    <div class="flex flex-wrap text-sm gap-2 my-1">
                        <button type="button" class="focus:outline-none text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ml-auto dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 ">Buy</button>
                    </div>
                </div>
