...
<body>
    ...
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
          <img src="{{asset('imgs/login_background.jpg')}}" alt="" class="w-full h-full object-cover">
        </div>
        ...
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
          ...
          <div class="w-full h-100">
            ...
            <form class="mt-6" method="POST" action="{{ route('login') }}">
              ...
              <button type="submit" class="w-full block bg-sky-500 hover:bg-sky-500 focus:bg-sky-500 text-white font-semibold rounded-lg
            ...
            <p class="mt-8">Need an account? <a href="{{route('register')}}" class="text-sky-500 hover:text-blue-700 font-semibold">Create an
                    account</a></p>
